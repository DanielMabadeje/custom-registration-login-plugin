...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo WP_PLUGIN_URL; ?>/finapp/includes/layouts/assets/img/favicon.png" sizes="32x32">
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo WP_PLUGIN_URL; ?>/finapp/includes/layouts/assets/img/icon/192x192.png">
...
<body>
    ...
    <!-- loader -->
    <div id="loader">
        <img src="<?php echo WP_PLUGIN_URL; ?>/finapp/includes/layouts/assets/img/loading-icon.png" alt="icon" class="loading-icon">
    </div>
    <!-- * loader -->
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST" && wp_verify_nonce($_POST['finapp-user-registration-form'], 'finapp-user-registration-form')) {
    ...
    <div id="appCapsule">
        ...
        <div class="section mb-5 p-2">
            <form action="" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                ...
                                <input type="password" class="form-control" id="password2" autocomplete="off" placeholder="Type password again">
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
                            </div>
                ...
                <?php wp_nonce_field('finapp-user-registration-form', 'finapp-user-registration-form'); ?>

                <div class="form-button-group transparent">
                    <button type="submit" name="" class="btn btn-primary btn-block btn-lg">Register</button>
                </div>
